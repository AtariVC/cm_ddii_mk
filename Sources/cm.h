...
{
	CMD_DBG_GET_TELEMETRIA, CM_DBG_CMD_SWITCH_MODE, CMD_DBG_GET_DATA_MPP, CM_DBG_CMD_CM_RESET,
	CM_DBG_CMD_CSA_TEST_ENABLE, CM_DBG_SET_CFG, CM_DBG_SET_VOLTAGE, CM_DBG_GET_CFG_VOLTAGE, 
	SET_DEFAULT_CFG, CM_DBG_GET_VOLTAGE, CM_DBG_GET_CFG_PWM, CMD_HVIP_ON_OFF,
...
enum mko_cmd_list
{
	...
	CMD_SET_MPP_OFFSET, CMD_CURRENT_LVL, CMD_PWR_CH_CTRL,
	CMD_START, CMD_HVIP_SET_MODE, CMD_HVIP_SET_VAL, CMD_HVIP_SET_PID,
	CMD_NUMBER
};
