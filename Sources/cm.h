...
enum mko_cmd_list
{
	CMD_TEST, CMD_SYNCH_TIME, CMD_INIT, CMD_SET_INTERVAL_MEASURE_S, CMD_CONST_MODE,
	...
	CM_SET_DEFAULT_CFG, CM_CSA_TEST, CM_READ_MEM, SET_V_HVIP, SET_PWM_HVIP, SET_MAX_PWM_HVIP,
	SET_TELEMETRIA,
	CMD_NUMBER
};
